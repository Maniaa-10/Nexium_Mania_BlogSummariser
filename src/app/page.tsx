      ...
      */}
      ...
      {language === "en" ? (
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 text-centre italic mt-4 px-15">
              ⚠️Only a few words translated via hardcoded limited JS dictionary</p>
              <p className="text-xs text-gray-600 text-right mt-1 px-38">
      ...
      <button
        ...
        className="fixed bottom-4 right-4 bg-indigo-400 hover:bg-pink-400 text-white rounded-full px-4 py-2 shadow-lg transition-all"
        >
        Home
      </button>
